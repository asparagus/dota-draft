...
class Arguments:
    ...
    MODEL_TEAM_CONVOLUTION_LAYERS = Argument('model.team_convolution.layers', List[int], default=[64, 64, 64])
    MODEL_TEAM_CONVOLUTION_TEAMMATE_CONNECTIONS = Argument('model.team_convolution.teammate_connections', bool, default=True)
    MODEL_TEAM_CONVOLUTION_OPPONENT_CONNECTIONS = Argument('model.team_convolution.opponent_connections', bool, default=True)
